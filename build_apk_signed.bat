...
:: Script para gerar APK assinado no Windows
set FLUTTER_DIR=flutter

echo [🚀] Iniciando build do APK assinado (APK)...
...
echo [🛠️] Compilando APK assinado...
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo [❌] Erro ao gerar o APK. Verifique os logs acima.
)
