-- Add freight_value to deliveries
ALTER TABLE public.deliveries ADD COLUMN IF NOT EXISTS freight_value NUMERIC;

-- Fix get_dashboard_stats to avoid freight value multiplication
...
BEGIN
  ...
  -- Get total freight value (summing directly from routes to avoid multiplication by deliveries)
  SELECT 
